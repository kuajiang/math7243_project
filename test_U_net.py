...
def pic_data(filepath='./'):
    ...
    names = [
        './train/epidural/',
        './train/intraparenchymal/',
        './train/intraventricular/',
        './train/subarachnoid/',
        './train/subdural/'
    ]
...
class U_net():
    ...
    def train(self,epochs=100):
        ...
        self.history = self.u_net.fit(train, label, batch_size=self.batch_size, epochs=epochs, callbacks=[checkpoint,early_stop], validation_split=0.1, shuffle=True)
